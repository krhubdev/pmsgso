<x-app-layout>
    ...
    <x-slot name="header">{{ __('Manage Custodian Records') }}</x-slot>
    <x-slot name="subHeader">{{ __('You can manage the custodian and register new custodian here.') }}</x-slot>
    <x-slot name="btn">
