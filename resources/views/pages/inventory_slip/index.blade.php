<x-app-layout>
    ...
    <x-slot name="header">{{ __('Manage Inventory Slips') }}</x-slot>
    <x-slot name="subHeader">{{ __('You can manage the inventory slips and register new slips here.') }}</x-slot>
    <x-slot name="btn">
                    ...
                    <div class="card-inner">
                        ...
                        <table class="datatable-init table-hover table">
                            <thead>
                                <tr>
                                    <th width="50">#</th>
                                    <th width="150">Fund</th>  
                                    <th width="240">Office</th>  
                                    <th width="240">Custodian</th>  
    ...
    @include('pages.inventory_slip.modal')
